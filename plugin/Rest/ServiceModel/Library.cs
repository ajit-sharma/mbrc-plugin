...
namespace MusicBeePlugin.Rest.ServiceModel
{
    ...
    {
        [ApiMember(Name = "limit", ParameterType = "query", DataType = "integer", IsRequired = false, Description = "The number of results contained in the response.")]
        public int limit { get; set; }

        [ApiMember(Name = "offset", ParameterType = "query", DataType = "integer", IsRequired = false, Description = "The position of the first entry in the response.")]
    ...
    {
        [ApiMember(Name = "id", ParameterType = "path", DataType = "integer", IsRequired = true, Description = "The id of the entry to retrieve.")]
